...
//   return (
//   <div>
//     <section className="relative flex flex-col lg:flex-row items-center justify-between min-h-screen py-16 px-6 bg-gradient-to-br from-gray-900  text-white overflow-hidden">
//       {/* Left Content */}
//       <motion.div
...
//         {/* Headline */}
//         <motion.h1
//           className="text-2xl md:text-5xl lg:text-3xl font-bold tracking-tight leading-tight"
...
//           <Button
//             className="bg-cyan-400 hover:bg-cyan-400 font-semibold py-3 px-6 rounded-full transition-all duration-300 flex items-center space-x-2"
//             asChild
//           >
...
import { ArrowDownToLine, Download, Wifi } from "lucide-react";
import { Button } from "./ui/button";
import { motion, useInView } from "framer-motion"; // Added useInView for scroll detection
import { useRef } from "react"; // Added useRef for section refs
import HeroInfo from "./HeroInfo";
import Skills from "./skills";
import Experience from "./Experience";
import Projects from "./Projects";
